        ...
        <img alt='Background' className='bg1' src={bg1} />
            <div className='homeblockthree-container'>
                ...
                <div className='container-quotes'>
                    <div>
                        <img alt='Quotes' className='quotes' src={quotes} />
                        ...
                        <img alt='Kady Baker' className='avatar' src={kady} />
                    </div>
                    <div>
                        <img alt='Quotes' className='quotes' src={quotes} />
                        ...
                        <img alt='Aiysha Reese' className='avatar' src={aiysha} />
                    </div>
                    <div>
                        <img alt='Quotes' className='quotes' src={quotes} />
                        ...
                        <img alt='Arthur Clarke' className='avatar' src={arhur} />
                    </div>
                </div>
            </div>
