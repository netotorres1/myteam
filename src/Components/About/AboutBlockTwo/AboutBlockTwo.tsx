  ...
  return (
    <section className='container-aboutblocktwo'>
        ...
        <div className='aboutblocktwo-content'>
            <div>
                <img alt='Nikita Marks' src={nikita} />
                <h3>Nikita Marks</h3>
                <span>Founder & CEO</span>
                <button onClick={handleOpenNikita}>{openNikita === false ? <button className='btnopen'><img alt='Open' className='icon' src={cross} /></button> : <button className='btnclose'><img alt='Close' className='icon' src={close} /></button>}</button>
            ...
            <div>
                <img alt='Cristian Duncan' src={christian} />
                <h3>Cristian Duncan</h3>
                <span>Co-founder & COO</span>
                <button onClick={handleOpenChristian}>{openChristian === false ? <button className='btnopen'><img alt='Open' className='icon' src={cross} /></button> : <button className='btnclose'><img alt='Close' className='icon' src={close} /></button>}</button>
            ...
            <div>
                <img alt='Cruz Hamer' src={cruz} />
                <h3>Cruz Hamer</h3>
                <span>Co-founder & CTO</span>
                <button onClick={handleOpenCruz}>{openCruz === false ? <button className='btnopen'><img alt='Open' className='icon' src={cross} /></button> : <button className='btnclose'><img alt='Close' className='icon' src={close} /></button>}</button>
            ...
            <div>
                <img alt='Drake Heaton' src={drake} />
                <h3>Drake Heaton</h3>
                <span>Business Development Lead</span>
                <button onClick={handleOpenDrake}>{openDrake === false ? <button className='btnopen'><img alt='Open' className='icon' src={cross} /></button> : <button className='btnclose'><img alt='Close' className='icon' src={close} /></button>}</button>
            ...
            <div>
                <img alt='Griffin Wise' src={griffin} />
                <h3>Griffin Wise</h3>
                <span>Lead Marketing</span>
                <button onClick={handleOpenGriffin}>{openGriffin === false ? <button className='btnopen'><img alt='Open' className='icon' src={cross} /></button> : <button className='btnclose'><img alt='Close' className='icon' src={close} /></button>}</button>
            ...
            <div>
                <img alt='Aden Allan' src={aden} />
                <h3>Aden Allan</h3>
                <span>Head of Talent</span>
                <button onClick={handleOpenAden}>{openAden === false ? <button className='btnopen'><img className='icon' alt='Open' src={cross} /></button> : <button className='btnclose'><img alt='Close' className='icon' src={close} /></button>}</button>
